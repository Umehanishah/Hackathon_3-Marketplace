...
export default function Navigation() {
    ...
    return ( 
        ...
        <div className="items-center pt-5">
            ...
            {/* logo */}
                <div className="bg-pink-50">
                    <div className="container w-[1000px] flex justify-between items-center md:mx-20 place-self-center">
                       <Link href="/">
                        <Image src="/logo.png" alt="logo" width={200} height={40} className="pb-2"/>
                        </Link>
                ...
                {/* nav bar  */}
                    <div className="container w-[500px] md:w-[1000px] flex py-5 items-center place-self-center">
        ...
        <div className="container w-[100px] place-self-center px-10"> 
        <Sheet>
        <SheetTrigger className="lg:hidden">
        ...
        <div className="pt-5">
         ...
         <ul className="pt-10">
                            ...
                            <li className="pt-3 text-sm text-gray-500 hover:text-pink-800 hover:font-semibold">
                            <Link href="/shop">Shop</Link>
                            </li>
                            <li className="pt-3 text-sm text-gray-500 hover:text-pink-800 hover:font-semibold">
