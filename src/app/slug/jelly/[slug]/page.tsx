...
const jelly = async (params:PageProps) => {
  ...
  return (
    <main>
      <Navigation/>
      <div className="container w-[400px] md:w-[700px] lg:w-[1000px] place-self-center py-10">
      <Breadcrumb>
      <BreadcrumbList>
        <BreadcrumbItem>
      ...
      <div className="container lg:w-[1000px] place-self-center lg:grid grid-cols-2 gap-10">
      <div className="container w-[500px] md:w-[700px] lg:w-[500px] md:h-[600px] place-self-center bg-cover">
      ...
      <div className='container w-[400px] md:w-[700px] lg:w-[500px] place-self-center pt-5'>
        <h2 className='text-xl lg:text-4xl font-bold pt-10 md:pt-0'>
          {jelly.name}
          </h2>
        
        <h3 className='container w-[150px] mt-5 mb-5 bg-pink-500 rounded-full text-center text-white text-base md:text-lg font-semibold py-2'>
          Rs. {jelly.price} 
          <span className='text-base md:text-lg text-gray-100 line-through pl-5'>150</span>
        </h3>
