...
export default function About() {
  return (
    <main>
      ...
      <Navigation />
      <div className="container w-[1100px] place-self-center">
      <div className="container w-[1000px] place-self-center py-10">
       ...
       <div className="container w-[1000px] place-self-center pb-10">
        <h1 className="text-xl font-bold py-5">
          Silver Linings of this Product</h1>
        <p className="text-base text-gray-900 font-justify py-4 leading-8">
        ...
        <ul className="text-base text-gray-900 font-justify py-4 list-disc leading-10">
