...
export default async function Data() {
  ...
  return (
    <div className="container mx-auto w-[400px] md:w-[700px] lg:w-[1000px] pt-5 lg:pt-0">
      <h1 className="text-lg md:text-xl lg:text-2xl text-center font-bold py-10">Our Heavenly Pudding Collection</h1>
  ...
  <div className="block lg:hidden px-10">
    <ScrollArea className="container w-[300px] md:w-[700px] place-self-center whitespace-nowrap rounded-md">
